...
const podcastObj = {
  ...
  desciption:
    'A soundcast that inspires you to master the grand expedition called being human. Hosted by Natasha Che, this weekly series explores consciousness, personal growth, creativity, relationship and inner awakening.',
  ...
  itunesSummary:
    'A soundcast that inspires you to master the grand expedition called being human. Hosted by Natasha Che, this weekly series explores consciousness, personal growth, creativity, relationship and inner awakening.', // need to be < 4000 characters
...
const episodeObj = {
  ...
  desciption:
    "<p>For most people, life is an inner war on a daily basis, from the smallest logistics...need to get out of bed, oh no!...to the paradigm-altering life decisions that you're too afraid to make. There's a firmly established command-and-judge program installed in almost everyone, to get the human self behave in such ways that the ego gets what it wants. These inner wars are exhausting (though you may not even be aware of it since you're so used to them). And they keep you from your deeper fulfillment and higher potential. Yet most of us simply don't know how to get out of the program. </p><p>In this episode, I talk about how you can start unwinding the internal conflicts and restoring peace inside by creating new responses to your self judgments.<p>", // may contain html
  ...
  enclosure: {
    url: 'https://s3.amazonaws.com/soundwiseinc/demo/1509908899352e.mp3',
  }, // link to audio file
  itunesAuthor: 'Natasha Che',
  itunesSubtitle: 'The True Voyage: A Soundcast on Inner Mastery', // need to be < 255 characters
  itunesSummary:
...
uploader.upload('s3', '1509908899352e.mp3', function(err, files) {
  ...
  firebase
    .database()
    .ref(`episodes/${episode.id}/id3Tagged`)
    .set(true);
});
...
let episodeObj,
  startEpisode = episodesArr.length > 50 ? episodesArr.length - 50 : 0; // only take the most recent 50 episodes
