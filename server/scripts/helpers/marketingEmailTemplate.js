...
module.exports.marketingEmailTemplate = (publisherName, publisherImage, emailBody) => {
  var emailShell = '';
  ...
  emailShell += '                        <br><br>';
  emailShell +=
    '                        <a href=\'[UNSUBSCRIBE]\'><unsubscribe style="color: #888888; text-decoration: underline;">unsubscribe</unsubscribe></a>';
  emailShell += '                    </td>';
  emailShell += '                </tr>';
  emailShell += '            </table>';
