    ...
    >
      <div className="container text-dark-gray" style={{ fontSize: '18px' }}>
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          distribute, sublicense, transmit, transfer, assign, perform and
          otherwise exploit Your submitted content (“Program”), an unlimited
          number of times in the media (“Media”) and territory (“Territory”) and
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          sold directly to consumers or businesses (collectively, “End Users”).
           Company’s Services currently include, but are not limited to, the
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          services. You will be provided audience related data on an aggregate
          level (“Audience Data”), including total listener signups and
          consumption of Your content, upon request, solely for personal
          information purposes. You are strictly prohibited from any use of
          Audience Data outside of personal use.
        </p>
        &nbsp;
        <ol start="2">
          <li>
        ...
        <ol type="a">
          ...
          <li style={{ fontWeight: '400' }}>
            <p style={{ fontWeight: '400' }}>
              ...
              include (i) any and all refunds, returns, credits, discounts,
              allowances and adjustments; (ii) any and all bad debt and/or
              credit card charges and/or expenses; and (iii) any and all taxes.
            </p>
          </li>
          &nbsp;
          <table style={{ width: '831px', border: '1px solid black' }}>
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          not limited to Company standards relating to quality.  If the
          Materials do not comply with such standards in any respect, in
          Company’s discretion, Company shall have the right to require Content
          Creator to replace promptly the unacceptable Materials. For the
          avoidance of doubt, Company has no obligation to exploit the Programs
          on the Services and may remove Programs from the Services any time
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          Services and may remove the Program from the Services any time
          throughout the License Period.
        </p>
        &nbsp;
        <p style={{ fontWeight: '400' }}>
          ...
          withhold any taxes, Company may (a) require Content Creator to
          reimburse Company in the amounts that should have been withheld; or
          (b) deduct the amounts that should have been withheld from future
          payments (if any).
        </p>
        &nbsp;
        <ol start="5">
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          businesses, worldwide in all media now known or hereafter created
          (“Publicity”).  Publicity may incorporate any elements from the
          Program and elements created by or for Company.  Company also has the
          right to use the publicity materials in connection with industry
          awards events and Company publicity which feature the Program during
          the License Period. Without limitation, Publicity may include the use
          of clips from the Program in magazine format programming for the
          purpose of promoting the Materials. No use hereunder shall constitute
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          Program with any other content, dubbing, subtitling and/or adding
          voiceover in any language, re-titling, and other customizations
          including, but not limited to, including all or any portion of the
          Program as part of an anthology or series of programs under the
          Program’s title or another title. Company may upon request by the
          Content Creator share alterations of the Program with the Content
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          materials requires reproduction of the Program, and/or portions or
          elements thereof. Company shall own the rights in the Company Works
          that it creates based upon the Program as described in section 4.1(c),
          except that You shall maintain all rights in the Program and Licensed
          Marks.
        </p>
        &nbsp;
        <p style={{ fontWeight: '400' }}>
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          moral rights or attribution obligations so that Company may exercise
          its rights hereunder without any payments or obligations to any third
          party.  Each Program is free of any moral rights or comparable
          obligations to any third party.  Use of the Licensed Marks by Company
          in connection with its exploitation of the Program will not violate or
          infringe upon any right of any kind or give right to any actionable
          claim or liability. Additionally, use of the Program by Company will
          not infringe on the intellectual property rights of a third party.
           Content Creator has obtained or will have obtained prior to the
          Delivery Date written releases and/or licenses for all elements in the
          Programs (e.g. people and music,) as necessary to ensure that the
          Program is in compliance with the terms of this sub section and that
          the exercise of the rights granted herein by Company and its
          successors and assignees will not violate any law, regulation or right
          of any kind whatsoever or give rise to any actionable claim or
          liability.
        </p>
        &nbsp;
        <p style={{ fontWeight: '400' }}>
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          solicitation (commercial or otherwise) through the Services or to any
          User.
        </p>
        &nbsp;
        <p style={{ fontWeight: '400' }}>
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          employees and agents of all such entities against and from any and all
          claims, damages, liabilities, costs and expenses (including, without
          limitation, reasonable outside counsel fees and disbursements) arising
          out of any breach or alleged breach by Content Creator of any
          representation, warranty or other provisions hereof.  In the event of
          any claim or service of process upon Content Creator involving the
          indemnification hereinbefore set forth, Content Creator shall promptly
          notify Company of the claim.  Content Creator will promptly adjust,
          settle, defend or otherwise dispose of such claim at her sole cost.
           If she so elects, Content Creator shall have the right at her sole
          cost to engage her own counsel in connection with such claim.  In the
          event that Company determines that Content Creator is not diligently
          and continuously defending any such claim, Company shall have the
          right, on its own behalf and as attorney-in-fact for Content Creator,
          to adjust, settle, defend or otherwise dispose of such claim.  Any
          costs incurred by Company in connection therewith shall be promptly
          reimbursed by Content Creator, and if Content Creator fails to so
          reimburse Company, Company shall be entitled to deduct such amounts
          from any other sums payable to Content Creator under the Agreement.
        </p>
        &nbsp;
        <ol start="8">
          <li>
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          otherwise specifically agreed hereunder.  These Terms not for the
          benefit of any third party not a signatory hereto and shall not be
          deemed to give any right or remedy to any such party whether referred
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          employees under laws or regulations, including, but not limited to,
          those relating to taxes, unemployment insurance, social security and
          workers’ compensation.  Each party shall identify itself in all
          transactions as a Content Creator or Company (as applicable) of, and
          separate legal entity from, the other party, as opposed to an agent
          and/or an integrated, divisional or consolidated part of the other
          party.{' '}
        </p>
        &nbsp;
        <p style={{ fontWeight: '400' }}>
          ...
          posted unless stated otherwise. If You continue to use Company
          Services, after the effective date of any change, then such access
          and/or use will be deemed an acceptance of and an agreement to follow
          and be bound by the Content Creator Terms as changed. The revised
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          District of Columbia.  Grantor waives any defenses based upon lack of
        ...
        <p style={{ fontWeight: '400' }}>
          ...
          under this Agreement shall be an action at law for damages; Grantor
          shall not be entitled to equitable relief.  Company shall be entitled
          to equitable relief in addition to any other right or remedies at law
          or otherwise.
        </p>
        &nbsp;
        <ol start="9">
