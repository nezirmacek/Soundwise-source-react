...
const Bannerright = () => (
  <div className="text-light-gray text-extra-large xs-text-extra-large width-95 margin-sixteen-bottom tz-text" data-selector=".tz-text" id="ui-id-19" style={ {  backgroundColor: 'rgba(0, 0, 0, 0)',  fontSize: 18,  fontWeight: 400,  fontFamily: '"Open Sans", sans-serif',  textTransform: 'none',  borderRadius: 0,  color: 'black'} }>
    ...
    <p>Soundwise is all about helping you learn new things efficiently. We think reading books takes too long. And we cringe at the idea of making you sit and watch talking-head
      lectures when your laundry pile is out of control.</p>
    <p>With Soundwise, you can absorb cutting-edge ideas and learn practical tools in business and life, when you're out riding your unicycle (or doing whatever cool
