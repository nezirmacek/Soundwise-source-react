...
const Pricing = (props) => (
  <div>
    <section className="padding-110px-tb xs-padding-60px-tb bg-white builder-bg" id="pricing-table5" style={{ paddingBottom: 80, paddingTop: 30,}}>
            ...
            <div className="row">
                <div className="col-xs-12 col-sm-6 col-md-6 xs-margin-bottom-20px sm-margin-bottom-20px" >
                    <ul className="pricing-box-style5 text-center bg-white builder-bg list-style-none">
                        ...
                        <li className="tz-border" style={{textAlign: 'left', paddingLeft: 15, paddingRight: 5}}><i className="far  fa-check-circle" style={{color: 'green', fontSize: 16}}></i><span style={{paddingLeft: 5}} className="text-medium text-dark-gray">Creating coupons and promotional sales pages</span></li>
                        ...
                        <li className="tz-border" style={{textAlign: 'left', paddingLeft: 15, paddingRight: 5}}><i className="far fa-check-circle" style={{color: 'green', fontSize: 16}}></i><span style={{paddingLeft: 5}} className="text-medium text-dark-gray">Automatic audio editing (leveling volume, trimming silence, adding intro/outro)</span></li>
