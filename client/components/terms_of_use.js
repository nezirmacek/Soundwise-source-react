  ...
  <div>
    ...
    <section className=" bg-white builder-bg xs-padding-60px-tb" id="contact-section2 border-none" style={{paddingBottom: '30px', paddingTop: '110px', boderBottom: '0px'}}>
      <div className='container text-dark-gray border-none' style={{fontSize: '18px'}}>
        <h3 className="section-title-medium text-dark-gray font-weight-600 alt-font margin-three-bottom display-block sm-margin-nine-bottom xs-margin-five-bottom tz-text" style={{textAlign: 'center'}}>Soundwise Terms of Use</h3>
        <h3 className='text-extra-large sm-text-extra-large font-weight-500 margin-ten-bottom xs-margin-fifteen-bottom display-block tz-text text-dark-gray' style={{textAlign: 'center'}}>(Last revised on: October 2, 2017)</h3>
        &nbsp;
        <p>
            Soundwise, Inc. (“Soundwise” or “Company”) provides an audio content
            management platform (the “Services”), which enables end-users (“Listeners”)
            to connect with independent audio content creators (the “Publishers,”
            collectively with Listeners, “you” or the “Users,” each a “User”) who
            provide audio training materials (the “Soundcasts”) through
            https://mysoundwise.com/ and subdomains, mobile applications, and other
            media managed by Soundwise (collectively, the “Sites”).
            <p>
            </p>
        </p>
        <p>
            These Terms of Use (these “<strong>Terms</strong>”) set forth the legally
            binding terms and conditions that govern your use of the Sitess. By
            accessing or using the Sitess, you are accepting these Terms (on behalf of
            yourself or the entity that you represent), and you represent and warrant
            ...
            access or use the Sitess or accept the Terms if you are not at least 18
            years old. If you do not agree with all of the provisions of these Terms,
            do not access and/or use the Sitess.
            <p>
            </p>
        </p>
        <p>
        ...
        <p>
             <strong>1. </strong><strong>Accounts </strong>
            <p>
            </p>
        </p>
        <p>
            ...
            In order to use certain features of the Sites, you must register for an
            account (“<strong>Account</strong>”) and provide certain information about
            ...
            information.
                ...
                the instructions on the Sites. Company may suspend or terminate your
        ...
        <p>
                ...
                non-exclusive, revocable, limited license to use and access the Sites
                for your own personal and commercial purposes.
        ...
        <p>
                ...
                assign, distribute, host, or otherwise commercially exploit the Sites,
                whether in whole or in part; (b) you shall not modify, make derivative
                ...
                similar or competitive websites, product, or service; and (d) except as
                expressly stated herein, no part of the Sites may be copied,
                ...
                Sites) must be retained on all copies thereof.
        ...
        <p>
                ...
                party for any modification, suspension, or discontinuation of the Sites
                or any part thereof.
                <p>
                </p>
        ...
        <p>
            ...
            you with any support or maintenance in connection with the Sites.
            <p>
            </p>
        </p>
        <p>
            ...
            copyrights, patents, trade marks, and trade secrets, in the Sites and its
            content are owned by Company or Company’s suppliers. Neither these Terms
            (nor your access to the Sites) transfers to you or any third party any
        ...
        <p>
             ...
             <strong>3. </strong><strong>Content</strong>
            <p>
            </p>
        </p>
        <p>
        ...
        <p>
            <strong>(a) </strong>
            “<strong>User Content</strong>” means any and all information and content
            that a user submits to, or uses with, the Sites (e.g., content in the
            ...
            3.5). You may not represent or imply to others that your User Content is in
        ...
        <p>
            <strong>(b) </strong>
            User Content is and remains that User’s property, and Soundwise’s only
            right to that User Content is the limited licenses to it granted in these
            Terms of Use. The Sites, and all Content other than User Content and all
            software available on the Sites or used to create and operate the Sites, is
            and remains the property of Soundwise, and is protected under the Copyright
            Act of 1976, as amended, and other intellectual property laws of the United
            States and any foreign jurisdiction where the Sites are accessed, and all
            rights to the Sites, such Content, and such software are expressly
            reserved. All trademarks and service marks, whether registered or
            unregistered, as well as product names and company names or logos,
            displayed or mentioned on the Sites are the property of their respective
            ...
            thereof by Soundwise.
            <p>
            </p>
        </p>
        <p>
            <strong>(c) </strong>
            Your User Content is your responsibility. Soundwise does not control or
            monitor User Content and, as such, does not guarantee in any manner the
            content, reliability, validity, accuracy, or truthfulness of such User
            Content, including but not limited to Content presented through the
            Soundcasts. By using the Services, you may be exposed to User Content that
            you consider offensive, indecent, or objectionable. Soundwise has no
            responsibility to keep such content from you and no liability for your
            access or use of any User Content to the extent permissible by law.
            Although we have no obligation to do so, we have the absolute discretion to
            remove, screen, or edit without notice any User Content posted or stored on
            the Sites, and we may do this at any time and for any reason.
            <p>
            </p>
        </p>
        <p>
            <strong>3.2 </strong>
            <strong>Your Limited License of Your User Content to Soundwise. </strong>
            While Soundwise does not claim any ownership interest in your User Content,
            we do need the right to use your User Content to the extent necessary to
            operate the Sites and provide the Services, now and in the future. For
            example, when a Publisher makes Soundcast materials available to its
            Listeners through the Sites or a Listener communicates with a Publisher on
            a comment section, Soundwise needs a license from those Users to display
            their respective Content on the Sites, as well as the right to sublicense
            that User Content to our other Users so that they can view that User
            Content. Therefore, by posting or distributing Content to or through the
            Sites, each User grants to Soundwise, and its affiliates and subsidiaries,
            a non-exclusive, royalty-free, transferable, irrevocable, worldwide license
            and right to use, display, publicly perform, reproduce, distribute,
            publish, modify, adapt, translate, create derivative works of, and
            otherwise use and exploit such User Content that you upload, transmit, or
            post on the Sites or through the Services, in the manner in and for the
            purposes for which the Sites from time to time uses such User Content. In
            doing so, the User represents and warrants that it owns and controls all of
            the rights to the User Content that it posts or otherwise distributes, and
            has the lawful right to post and distribute that User Content, to or
            through the Sites, and the use and posting or other transmission of such
            User Content does not violate these Terms of Use and will not violate any
            rights of or cause injury to any other person or entity. If your User
            Content is intended for the use by other Users, you also grant us and our
            affiliates and subsidiaries a non-exclusive, royalty-free, transferable
            right to sublicense such User Content to such Users for their use in
            connection with their use of the Sites.
            <p>
            </p>
        </p>
        <p>
            <strong>3.3 </strong>
            <strong>Soundwise’s Limited License of Content to Users. </strong>
            Soundwise grants to Users a limited, revocable, non-exclusive,
            non-sublicensable license to view, copy, and print the portions of the
            Content available to Users on the Sites. For Listeners, this includes
            access and use of the Soundcasts and content provided therein, which they
            have subscribed to and paid all required fees for. Such license is subject
            to these Terms of Use, and specifically conditioned upon the following:
            <p>
            </p>
        </p>
        <p>
            · Users may only view, copy, and print such portions of the Content for
            their own use;
            <p>
            </p>
        </p>
        <p>
            · Users may not modify or otherwise make derivative works of the Content,
            or reproduce, distribute, or display the Content (except for page caching)
            except as expressly permitted in these Terms of Use;
            <p>
            </p>
        </p>
        <p>
            · Users may not remove or modify any copyright, trademark, or other
            proprietary notices that have been placed in the Content;
            <p>
            </p>
        </p>
        <p>
            · Users may not use any data mining, robots, or similar data gathering or
            extraction methods; and
            <p>
            </p>
        </p>
        <p>
            · Users may not use the Sites or Content other than for their intended
            purposes.
            <p>
            </p>
        </p>
        <p>
            ...
            and will terminate the license granted herein, these Terms of Use, and your
            access to the Sites. Any such unauthorized use may also violate applicable
            laws, including without limitation copyright and trademark laws. Unless
            explicitly stated herein, nothing in these Terms of Use may be construed as
            conferring any license to intellectual property rights, whether by
            estoppels, implication, or otherwise. Soundwise may revoke this license at
            any time for any reason or no reason, and shall not be liable to any User
            for any purported interference with business or contractual relations, in
            tort or otherwise. Users represent and warrant that their use of the Sites
            and the Content will remain consistent with this license and will not
            infringe or violate the rights of any other party or breach any contract or
            legal duty to any other parties, or violate any applicable law. To request
            permission for uses of Content not included in this license, you may
            contact Soundwise at the address set out at the bottom of these Terms of
            Use.
            <p>
            </p>
        </p>
        <p>
            <strong>3.4 </strong>
            <strong>Relationship with Publishers and Listeners. </strong>
            <strong> </strong>
            Company provides a platform upon which Publishers may create, offer for
            sale, and administer Soundcasts to Listeners. Company is neither a content
            provider nor an educational institution. Publishers are not employees of
            Company. Company is not responsible for interactions between Publishers and
            Listeners, with the exception of providing the technological means through
            which Publishers may broadcast and otherwise make available their
            Soundcasts and, at each Publisher’s election, for processing payments
            through Company’s payment gateway. Company is not liable for any disputes,
            claims, losses, injuries, or damage of any kind that may arise out of the
            Publisher/Listener relationship, including but not limited to, any
            Listener’s reliance upon any information provided by a Publisher at any
            time.
            <strong>
                <p>
                </p>
        ...
        <p>
            <strong>(a) </strong>
            You agree not to use the Sites to collect, upload, transmit, display, or
        ...
        <p>
            ...
            through the Sites any computer viruses, worms, or any software intended to
            damage or alter a computer system or data; (ii) send through the Sites
            ...
            unsolicited messages, whether commercial or otherwise; (iii) use the Sites
            ...
            to the Sites, or violate the regulations, policies or procedures of such
            networks; (v) attempt to gain unauthorized access to the Sites (or to other
            computer systems or networks connected to or used together with the Sites),
            whether through password mining or any other means; (vi) harass or
            interfere with any other user’s use and enjoyment of the Sites; or (vi) use
            software or automated agents or scripts to produce multiple accounts on the
            Sites, or to generate automated searches, requests, or queries to (or to
            strip, scrape, or mine data from) the Sites (provided, however, that we
            conditionally grant to the operators of public search engines revocable
            permission to use spiders to copy materials from the Sites for the sole
        ...
        <p>
                ...
                terminating your Account in accordance with Section
        ...
        <p>
            ...
            If you provide Company with any feedback or suggestions regarding the Sites
            (“<strong>Feedback</strong>”), you hereby assign to Company all rights in
        ...
        <p>
                ...
                your use of the Sites, (b) your violation of these Terms, (c) your
        ...
        <p>
            ...
            The Sites may contain links to third-party websites and services, and/or
        display advertisements for third parties (collectively, “    <strong>Third-Party Links &amp; Ads</strong>”). Such Third-Party Links
        ...
        <p>
            ...
            Each Sites user is solely responsible for any and all of its own User
            ...
            Sites users are solely between you and such users. You agree that Company
            will not be responsible for any loss or damage incurred as the result of
            any such interactions. If there is a dispute between you and any Sites
        ...
        <p>
            ...
            or that relates directly or indirectly to, the Sites (including any
            interactions with, or act or omission of, other Sites users or any
        ...
        <p>
            THE SITES IS PROVIDED ON AN “AS-IS” AND “AS AVAILABLE” BASIS, AND COMPANY
            ...
            SUPPLIERS) MAKE NO WARRANTY THAT THE SITES WILL MEET YOUR REQUIREMENTS,
            ...
            RESPECT TO THE SITES, ALL SUCH WARRANTIES ARE LIMITED IN DURATION TO NINETY
        ...
        <p>
            ...
            SITES, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
            ACCESS TO, AND USE OF, THE SITES IS AT YOUR OWN DISCRETION AND RISK, AND
        ...
        <p>
                ...
                effect while you use the Sites. We may s

            uspend or terminate your rights to use the Sites (including your Account)
            at any time for any reason at our sole discretion, including for any use of
            the Sites in violation of these Terms. Upon termination of your rights
            under these Terms, your Account and right to access and use the Sites will
        ...
        <p>
            ...
            our Sites do the same. In connection with our Sites, we have adopted and
            ...
            circumstances, of users of our online Sites who are repeat infringers of
            intellectual property rights, including copyrights. If you believe that one
            of our users is, through the use of our Sites, unlawfully infringing the
        ...
        <p>
             <strong>10. </strong><strong>General</strong>
            <strong>
                <p>
                </p>
            </strong>
        ...
        <p>
             <strong>10.1 </strong><strong>Changes. </strong>
            ...
            notice of the changes on our Sites. You are responsible for providing us
            ...
            calendar days following our posting of notice of the changes on our Sites.
            These changes will be effective immediately for new users of our Sites.
            Continued use of our Sites following notice of such changes shall indicate
        ...
        <p>
            ...
            the other party a written Notice of Dispute (<strong>“Notice”</strong>)
            describing the nature and basis of the claim or dispute, and the requested
            relief. A Notice to the Company should be sent to: Unit 302, 2818
            Connecticut Ave NW, Washington, District Of Columbia 20008. After the
            Notice is received, you and the Company may attempt to resolve the claim or
            dispute informally. If you and the Company do not resolve the claim or
            dispute within thirty (30) days after the Notice is received, either party
            may begin an arbitration proceeding. The amount of any settlement offer
            made by any party may not be disclosed to the arbitrator until after the
            arbitrator has determined the amount of the award, if any, to which either
            party is entitled.
            <p>
            </p>
        </p>
        <p>
            ...
            alternative dispute resolution provider (<strong>“ADR Provider”</strong>)
            ...
            arbitration, including but not limited to the method of initiating and/or
            demanding arbitration, except to the extent such rules are in conflict with
        the Terms. The AAA Consumer Arbitration Rules (    <strong>“Arbitration Rules”</strong>) governing the arbitration are
            available online at <a href="http://www.adr.org">www.adr.org </a>  or by
            ...
            its own costs (including attorney’s fees) and disbursements arising out of
            the arbitration and shall pay an equal share of the fees and costs of the
            ADR Provider.
            <p>
            </p>
        </p>
        ...
        <p>
            ...
            BASIS, AND CLAIMS OF MORE THAN ONE CUSTOMER OR USER CANNOT BE ARBITRATED OR
        ...
        <p>
            ...
            . All aspects of the arbitration proceeding, including but not limited to
            the award of the arbitrator and compliance therewith, shall be strictly
        ...
        <p>
            ...
            personal jurisdiction of the courts located within Washington County,
            District Of Columbia, for such purpose
            <p>
            </p>
        </p>
        <p>
            ...
            The Sites may be subject to U.S. export control laws and may be subject to
        ...
        <p>
            ...
            Company is located at the address in Section 10.9. If you are a California
        ...
        <p>
            ...
            you use the Sites or send us emails, or whether Company posts notices on
            the Sites or communicates with you via email. For contractual purposes, you
        ...
        <p>
            ...
            These Terms and the Privacy Policy constitute the entire agreement between
            you and us regarding the use of the Sites. Our failure to exercise or
            ...
            Terms is, for any reason, held to be invalid or unenforceable, the other
        ...
        <p>
            ...
            logos and service marks (“<strong>Marks</strong>”) displayed on the Sites
        ...
        <p>
            Unit 302, 2818 Connecticut Ave NW
            <p>
            </p>
        </p>
        <p>
