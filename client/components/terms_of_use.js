    ...
    >
      ...
      >
        ...
        <p>
          ...
          management platform (the “Services”), which enables end-users
          (“Listeners”) to connect with independent audio content creators (the
          “Publishers,” collectively with Listeners, “you” or the “Users,” each
          a “User”) who provide audio training materials (the “Soundcasts”)
          through https://mysoundwise.com/ and subdomains, mobile applications,
          and other media managed by Soundwise (collectively, the “Sites”).
          <p />
        </p>
        <p>
        ...
        <p>
          ...
          that occur under your Account. You agree to immediately notify Company
          of any unauthorized use, or suspected unauthorized use of your Account
          or any other breach of security. Company cannot and will not be liable
        ...
        <p>
          ...
          copyrights, patents, trade marks, and trade secrets, in the Sites and
          its content are owned by Company or Company’s suppliers. Neither these
          Terms (nor your access to the Sites) transfers to you or any third
        ...
        <p>
          ...
          right to that User Content is the limited licenses to it granted in
          these Terms of Use. The Sites, and all Content other than User Content
          and all software available on the Sites or used to create and operate
          the Sites, is and remains the property of Soundwise, and is protected
          under the Copyright Act of 1976, as amended, and other intellectual
          property laws of the United States and any foreign jurisdiction where
          the Sites are accessed, and all rights to the Sites, such Content, and
          such software are expressly reserved. All trademarks and service
          marks, whether registered or unregistered, as well as product names
          and company names or logos, displayed or mentioned on the Sites are
          ...
          endorsement, sponsorship, or recommendation thereof by Soundwise.
          <p />
        </p>
        <p>
          <strong>(c) </strong>
          Your User Content is your responsibility. Soundwise does not control
          or monitor User Content and, as such, does not guarantee in any manner
          the content, reliability, validity, accuracy, or truthfulness of such
          User Content, including but not limited to Content presented through
          the Soundcasts. By using the Services, you may be exposed to User
          Content that you consider offensive, indecent, or objectionable.
          Soundwise has no responsibility to keep such content from you and no
          liability for your access or use of any User Content to the extent
          permissible by law. Although we have no obligation to do so, we have
          the absolute discretion to remove, screen, or edit without notice any
          User Content posted or stored on the Sites, and we may do this at any
        ...
        <p>
          <strong>3.2 </strong>
          <strong>
            Your Limited License of Your User Content to Soundwise.{' '}
          </strong>
          While Soundwise does not claim any ownership interest in your User
          Content, we do need the right to use your User Content to the extent
          necessary to operate the Sites and provide the Services, now and in
          the future. For example, when a Publisher makes Soundcast materials
          available to its Listeners through the Sites or a Listener
          communicates with a Publisher on a comment section, Soundwise needs a
          license from those Users to display their respective Content on the
          Sites, as well as the right to sublicense that User Content to our
          other Users so that they can view that User Content. Therefore, by
          posting or distributing Content to or through the Sites, each User
          grants to Soundwise, and its affiliates and subsidiaries, a
          non-exclusive, royalty-free, transferable, irrevocable, worldwide
          license and right to use, display, publicly perform, reproduce,
          distribute, publish, modify, adapt, translate, create derivative works
          of, and otherwise use and exploit such User Content that you upload,
          transmit, or post on the Sites or through the Services, in the manner
          in and for the purposes for which the Sites from time to time uses
          such User Content. In doing so, the User represents and warrants that
          it owns and controls all of the rights to the User Content that it
          posts or otherwise distributes, and has the lawful right to post and
          distribute that User Content, to or through the Sites, and the use and
          posting or other transmission of such User Content does not violate
          these Terms of Use and will not violate any rights of or cause injury
          to any other person or entity. If your User Content is intended for
          the use by other Users, you also grant us and our affiliates and
          subsidiaries a non-exclusive, royalty-free, transferable right to
          sublicense such User Content to such Users for their use in connection
          with their use of the Sites.
          <p />
        </p>
        <p>
          <strong>3.3 </strong>
          ...
          access and use of the Soundcasts and content provided therein, which
          they have subscribed to and paid all required fees for. Such license
          is subject to these Terms of Use, and specifically conditioned upon
          the following:
          <p />
        </p>
        <p>
          · Users may only view, copy, and print such portions of the Content
          for their own use;
          <p />
        </p>
        <p>
          · Users may not modify or otherwise make derivative works of the
          Content, or reproduce, distribute, or display the Content (except for
          page caching) except as expressly permitted in these Terms of Use;
          <p />
        </p>
        <p>
        ...
        <p>
          · Users may not use any data mining, robots, or similar data gathering
          or extraction methods; and
          <p />
        </p>
        <p>
        ...
        <p>
          ...
          prohibited and will terminate the license granted herein, these Terms
          of Use, and your access to the Sites. Any such unauthorized use may
          also violate applicable laws, including without limitation copyright
          and trademark laws. Unless explicitly stated herein, nothing in these
          Terms of Use may be construed as conferring any license to
          intellectual property rights, whether by estoppels, implication, or
          otherwise. Soundwise may revoke this license at any time for any
          reason or no reason, and shall not be liable to any User for any
          purported interference with business or contractual relations, in tort
          or otherwise. Users represent and warrant that their use of the Sites
          and the Content will remain consistent with this license and will not
          infringe or violate the rights of any other party or breach any
          contract or legal duty to any other parties, or violate any applicable
          law. To request permission for uses of Content not included in this
          license, you may contact Soundwise at the address set out at the
          bottom of these Terms of Use.
          <p />
        </p>
        <p>
          <strong>3.4 </strong>
          ...
          <strong> </strong>
          Company provides a platform upon which Publishers may create, offer
          for sale, and administer Soundcasts to Listeners. Company is neither a
          content provider nor an educational institution. Publishers are not
          employees of Company. Company is not responsible for interactions
          between Publishers and Listeners, with the exception of providing the
          technological means through which Publishers may broadcast and
          otherwise make available their Soundcasts and, at each Publisher’s
          election, for processing payments through Company’s payment gateway.
          Company is not liable for any disputes, claims, losses, injuries, or
          damage of any kind that may arise out of the Publisher/Listener
          relationship, including but not limited to, any Listener’s reliance
          upon any information provided by a Publisher at any time.
          <strong>
            <p />
          </strong>
        </p>
        ...
        <p>
          <strong>(a) </strong>
          You agree not to use the Sites to collect, upload, transmit, display,
        ...
        <p>
          ...
          or through the Sites any computer viruses, worms, or any software
          intended to damage or alter a computer system or data; (ii) send
          through the Sites unsolicited or unauthorized advertising, promotional
          ...
          or otherwise; (iii) use the Sites to harvest, collect, gather or
          ...
          create an undue burden on servers or networks connected to the Sites,
          or violate the regulations, policies or procedures of such networks;
          (v) attempt to gain unauthorized access to the Sites (or to other
          computer systems or networks connected to or used together with the
          Sites), whether through password mining or any other means; (vi)
          harass or interfere with any other user’s use and enjoyment of the
          Sites; or (vi) use software or automated agents or scripts to produce
          multiple accounts on the Sites, or to generate automated searches,
          requests, or queries to (or to strip, scrape, or mine data from) the
          Sites (provided, however, that we conditionally grant to the operators
          of public search engines revocable permission to use spiders to copy
          materials from the Sites for the sole purpose of and solely to the
        ...
        <p>
          ...
          any other person . Such action may include removing or modifying your
        ...
        <p>
          ...
          interactions with other Sites users are solely between you and such
          ...
          dispute between you and any Sites user, we are under no obligation to
          become involved.
          <p />
        </p>
        <p>
          ...
          Sites (including any interactions with, or act or omission of, other
          Sites users or any Third-Party Links &amp; Ads). IF YOU ARE A
        ...
        <p>
          ...
          effect while you use the Sites. We may s uspend or terminate your
        ...
        <p>
          ...
          users of our Sites do the same. In connection with our Sites, we have
          ...
          Sites who are repeat infringers of intellectual property rights,
          including copyrights. If you believe that one of our users is, through
          the use of our Sites, unlawfully infringing the copyright(s) in a
        ...
        <p>
          ...
          posting notice of the changes on our Sites. You are responsible for
          ...
          following our posting of notice of the changes on our Sites. These
          changes will be effective immediately for new users of our Sites.
          Continued use of our Sites following notice of such changes shall
        ...
        <p>
          ...
          be resolved informally or in small claims court shall be resolved by
          ...
          agents, employees, predecessors in interest, successors, and assigns,
          as well as all authorized or unauthorized users or beneficiaries of
        ...
        <p>
          ...
          be initiated and/or demanded within the statute of limitations (i.e.,
          the legal deadline for filing a claim) and within any deadline imposed
        ...
        <p>
          ...
          to the personal jurisdiction of the courts located within Washington
          County, District Of Columbia, for such purpose
          <p />
        </p>
        <p>
          <strong>10.3 </strong>
          <strong>Export. </strong>
          The Sites may be subject to U.S. export control laws and may be
        ...
        <p>
          ...
          Company is located at the address in Section 10.9. If you are a
        ...
        <p>
          ...
          whether you use the Sites or send us emails, or whether Company posts
          notices on the Sites or communicates with you via email. For
