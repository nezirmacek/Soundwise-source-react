          ...
          <div className="row equalize xs-equalize-auto">
            ...
            >
              <div className="border-radius-6 box-shadow bg-white builder-bg padding-nineteen sm-padding-eleven xs-padding-seventeen xs-width-100 display-table-cell-vertical-middle">
                ...
                <ul className="text-large  text-dark-gray margin-twenty-three-bottom tz-text">
                  ...
                  <li>
                    I can’t make money from it anyway. I won’t have gazillion
                    downloads to sell ads on.
                  </li>
                </ul>
              </div>
            </div>
            ...
            >
              <div className="border-radius-6 box-shadow bg-white builder-bg padding-nineteen sm-padding-eleven xs-padding-seventeen xs-width-100 display-table-cell-vertical-middle">
                ...
                <ul className="text-large text-dark-gray margin-twenty-three-bottom tz-text">
                  <li>
                    They are in CDs. Managing inventory and shipping is a bore.
                    And they make my business look like a dinosaur.{' '}
                  </li>
                  <li>
                    They are in mp3 downloads. Students can send them to anyone
                    who didn’t pay. I have no idea what happened to them.
                  </li>
                </ul>
              </div>
            </div>
            ...
            >
              <div className="border-radius-6 box-shadow bg-white builder-bg padding-nineteen sm-padding-eleven xs-padding-seventeen xs-width-100 display-table-cell-vertical-middle">
                ...
                <ul className="text-large text-dark-gray margin-twenty-three-bottom tz-text">
                  <li>
                    It’s hard to make people show up at a set time. Everyone’s
                    so busy.
                  </li>
                  <li>
                    Students have been bugging me to record the trainings so
                    that they can listen to it later. But how would I know if
                    they do?
                  </li>
                </ul>
              </div>
