                          ...
                          <div className="slider-text-middle text-left padding-left-right-px">
                              <div className="col-md-6 no-padding margin-twenty-top sm-margin-twenty-three-top header-banner">
                                  ...
                                  <div className="float-left width-100">
                                      <a className="btn btn-large propClone text-black xs-margin-ten-bottom xs-width-100 float-left" href="http://eepurl.com/cX2uof" style={{backgroundColor: '#F76B1C'}}><span className="tz-text">TRY IT FOR FREE</span></a>
