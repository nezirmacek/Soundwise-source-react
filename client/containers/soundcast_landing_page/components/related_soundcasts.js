...
function SliderNextArrow(props) {
  const {onClick} = props;
  return (
    <div className="slick-override-arrow -next-arrow" onClick={onClick}><i className="ti-angle-right" /></div>
  );
}
...
function SliderPrevArrow(props) {
  const {onClick} = props;
  return (
    <div className="slick-override-arrow -prev-arrow" onClick={onClick}><i className="ti-angle-left" /></div>
  );
}
      ...
      return (
        <section className=" bg-white related-courses" >
          <div className='container' >
            <div className='padding-30px-tb xs-padding-30px-tb' style={{ borderBottom: '0.5px solid lightgrey'}}>
              <div className="row " >
              ...
              <div style={style.sliderWrapper} className="row ">
                {
                  ...
                  <div className='col-md-12 center-col slick-slide' style={{display: 'flex', justifyContent: 'space-evenly'}}>
                    {
