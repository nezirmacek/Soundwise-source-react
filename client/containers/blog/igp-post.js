              ...
              <div className="container post-container md-padding-twenty-five-left md-padding-twenty-five-right xs-padding-nine-left xs-padding-nine-right" >
                ...
                <div className='row'>
                  <div className="social social-icon-color text-extra-large sm-text-extra-large  margin-ten-bottom xs-margin-fifteen-bottom display-block tz-text col-md-12 col-sm-12 col-xs-12 text-center " style={{}}>
                      ...
                      <a target="_blank" href={`http://www.facebook.com/sharer/sharer.php?u=https://mysoundwise.com/igp/${post.slug}`} className="margin-eight-right">
                          <i className="icon-large sm-icon-extra-small fab fa-facebook-f tz-icon-color"></i>
                      </a>
                      <a target="_blank" href={`https://twitter.com/intent/tweet?text=${post.title}. https://mysoundwise.com/igp/${post.slug}`} className="margin-eight-right">
                          <i className="icon-large sm-icon-extra-small fab fa-twitter tz-icon-color"></i>
                      </a>
                      <a target="_blank" href={`https://plus.google.com/share?url=https://mysoundwise.com/igp/${post.slug}`} className="margin-eight-right">
                          <i className="icon-large sm-icon-extra-small fab fa-google-plus-g tz-icon-color"></i>
                      </a>
                      <a target="_blank" href={`https://www.linkedin.com/shareArticle?mini=true&amp;url=https%3A//mysoundwise.com/igp/${post.slug}&amp;title=${post.seo_title}&amp;source=`} className="margin-eight-right">
              ...
              <div className="container">
                  <div className="row">
                      <div className="col-md-12 col-sm-12 col-xs-12 text-center ">
                          <h3 style={{marginBottom: 0}} className="title-small sm-title-small xs-title-small text-dark-gray font-weight-700 alt-font tz-text">THE INNER GAME OF PODCASTING</h3>
                          <h2 style={{marginTop: 0}} className="title-extra-large-2 sm-title-large xs-title-large text-dark-gray font-weight-700 alt-font margin-five-bottom  xs-margin-nine-bottom tz-text">MORE STORIES</h2>
                      </div>
                  </div>
                  <div className="row">
