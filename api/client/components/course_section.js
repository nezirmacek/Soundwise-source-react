...
class _CourseSection extends Component {
                    ...
                    <a href={this.props.section.notes_url} target="_blank" className="notesWrapper">
                        {
                            ...
                            (
                                <div style={{position: 'relative'}}>
                                    ...
                                    <PDF file={this.props.section.notes_url}
                                         onDocumentComplete={this.onDocumentComplete.bind(this)}
                                         onPageComplete={this.onPageComplete.bind(this)} page={this.state.page}
                                    />
                                    {
                                        this.state.pages > 1
                                        &&
                                        <IoChevronRight style={{...styles.navIcon, right: 0}} onClick={this.handleNext.bind(this)} />
                                        ||
                                        null
                                    }
                                </div>
    ...
    render() {
        ...
        const completed = this.props.course.sectionProgress
